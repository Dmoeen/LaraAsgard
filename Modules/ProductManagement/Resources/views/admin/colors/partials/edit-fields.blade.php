<div class="box-body">
    ...
    <div class="form-group">
        ...
        <div class="input-group ">
            ...
            <input class="form-control form-control-lg" type="number" name="price" value="{{$color->price}}" placeholder="Price"
                   min="0">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="input-group date">
            ...
            <input type="text" name="expiry_date" value="{{$color->expiry_date}}" class="form-control pull-right datepicker">
        </div>
        <!-- /.input group -->
    </div>
    ...
    <div>
        <td><img class="img-thumbnail" src="{{'http://localhost/images/'.$color->image_name}}" alt="Smiley face" height="150" width="150"></td>
    </div>
</div>
